...
a customer did not place an order) or deleted. Since these sstored baskets won't be needed anymore and there's a
...
remove them one by one. At the end of the process, and an object with the following structure will be both logged and

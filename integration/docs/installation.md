...
| EE_INCOMING_IDENTIFIER                     | ✅        |                                     | EagleEye Outlet Incoming Identifier (can be overriden in cart, see [here](how-it-works.md#dynamic-location-identifiers))                                                                                                                                                                                                                                                                                                                                                                                   |
| EE_PARENT_INCOMING_IDENTIFIER              | 🚫       |                                     | EagleEye Outlet's Parent unit Incoming Identifier (can be overriden in cart, see [here](how-it-works.md#dynamic-location-identifiers))                                                                                                                                                                                                                                                                                                                                                                     |
...
| CT_LINE_ITEM_TYPE_KEY                           | 🚫       | custom-line-item-type                    | Allows to change the custom line item type key. Useful if there is already another custom line item type used in the commercetools project                                                                                                                                                                                                                                                                                       |
...
| BASKET_CLEANUP_OLDER_THAN_VALUE                            | 🚫       | 1                                    | Number for time reference to use when querying old custom objects. E.g.: `5`, for older than 5 days                                                                                                                                                                 |
